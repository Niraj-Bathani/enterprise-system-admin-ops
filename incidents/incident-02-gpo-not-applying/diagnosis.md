...
4. Run the incident-specific command: `gpresult /h C:\Logs\sales-gpo.html`.
5. Open Event Viewer on `DC01` and filter Security logs for the relevant event IDs: GroupPolicy Operational 5312, 5317, 7016.
