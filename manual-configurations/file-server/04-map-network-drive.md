...
1. On `CLIENT01`, open File Explorer.
2. Choose Map network drive.
3. Select drive `S:`.
4. Enter `\\FS01\Sales`.
5. Check reconnect at sign-in.
6. For domain deployment, create a Drive Maps preference in GPMC.
...
- **Drive maps but access denied:** The path is reachable but permissions are wrong; review NTFS and group membership.
- **Drive does not reconnect:** Check credential prompts and GPO refresh.
...
Continue with [05-access-denied-fix.md](05-access-denied-fix.md).
